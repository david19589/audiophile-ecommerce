...
function Cart(props: { setOpenCart: (status: boolean) => void }) {
  ...
  return (
    <div className="flex justify-end items-start fixed top-[5.6rem] left-0 right-0 bottom-0 z-10 bg-[#000000c5]">
      <div className="lg:mr-[10rem] md:px-[2.5rem] md:mr-[2.5rem] bg-[#FFF] max-w-[23.5rem] w-full gap-[0.625rem] p-[2rem] mt-[2rem] mx-[1.5rem] rounded-lg">
